      ...
      <div className="max-w-sm mt-20 sm:mx-4 mx-auto focus:outline-none">
        ...
        >
          ...
          <p className="hidden sm:block text-gray-700 dark:text-gray-400 font-montserrat font-normal">
            ...
            Materiali pregiati e possibilità di controllo costante della
            pressione di erogazione esercitata abbassando...
          </p>
